document.addEventListener("DOMContentLoaded", () => {
        ...
        const protectImages = () => {
            document.querySelectorAll("img").forEach(img => {
                ...
                img.addEventListener("contextmenu", (e) => {
                    e.preventDefault();
                    showGlassNotification("Foto ini spesial, cobaa liatt! 💕", false);
                    return false;
                });
    ...
    const surpriseMessages = [
        ...
        "Setiap momen bersama kita semoga selalu menjadi pengingat untuk bertahan 🌹",
        "Kamu dan aku bikin pelangi warna-warni aja yaa jangan item deh jelek 🌈",
        "JANGAN NANYA MULU KAMU SAYANG SAMA AKU APA NGGAAA 🙏",
        "Rasa sayang aku ke kamu akan selalu bertumbuh 💖",
        "Semoga nanti kita bisa membuat rumah yang saling merasakan kenyamanan 🏠💕",
        "Bersama-sama dan bertahap 👵👴💑",
        "Makasih udah selalu ngertiin ego aku yang kadang lebih dari kamu ✨💫",
        "Maaf juga kalo masih sering bikin nangis yaa 🤝❤️",
        "Semoga kita selalu bisa menulis halaman baru yang halaman tamatnya masih seabad wkwk 📖💕",
        "HAPPY 365 DAYS 💘",
        "I LOVE U 🥰"
    ];
